<?php
    ...
    public function update()
    {
        ...
        {
            $this->session->set_flashdata('facility_action', 'facility_updated');
            redirect('facility/facility_index');
        }
        else
        {
            $this->session->set_flashdata('facility_action', 'facility_update_failed');
            redirect('facility/facility_index');
        }
    }
    // Delete facility
    ...
    {
        $this->facility_model->delete_facility($delete_id);
        redirect('facility/facility_index');
    }
    }
?>