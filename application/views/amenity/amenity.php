									...
									<table id="datatables-buttons" class="table table-striped" style="width:100%">
										...
										<tbody>
											...
											<tr>
												...
												data-data='<?= json_encode($amenity)?>' data-action="update">
												<i data-feather="edit"></i>
												</button>
												<a href="<?php echo base_url('amenity/delete/' .$amenity->id);?>" onclick="return confirm('Are you sure you want to remove this facility? This action cannot be undone.');"><button class ="btn border-0 text-danger"><i data-feather="trash"></i></button></a>
